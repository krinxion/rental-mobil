    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_mobil" placeholder="Tambahkan Nama Mobil" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="warna_mobil" placeholder="Tambahkan warna Mobil" required>
        </div>
        <div class="form-group">
